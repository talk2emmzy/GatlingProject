...
public class inflowreport extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("inflowreport")
    .exec(
      http("request_0")
        .get("/OAGFLogo.png")
        .headers(headers_0)
        .resources(
          http("request_1")
            .get("/static/media/filter.7e71973a2d6503165f8684774b9cf30a.svg")
            .headers(headers_1),
          http("request_2")
            .options(uri2 + "/api/organizations/inflow-payment-summary?size=10000")
            .headers(headers_2),
          http("request_3")
            .options(uri2 + "/services/organization/api/organizations/1-4-1/descendants")
            .headers(headers_2),
          http("request_4")
            .options(uri2 + "/services/organization/api/organizations/64bd154645b00d68611793b9/find-services")
            .headers(headers_2),
          http("request_5")
          ...
          http("request_6")
            ...
            .headers(headers_5),
          http("request_7")
            .get(uri2 + "/services/organization/api/organizations/64bd154645b00d68611793b9/find-services")
            .headers(headers_5),
          http("request_8")
            .get(uri2 + "/api/organizations/inflow-payment-summary?size=10000")
            .headers(headers_5)
        )
    );
